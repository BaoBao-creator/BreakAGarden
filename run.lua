...
game:GetService("ReplicatedStorage").GameEvents.PetsService:FireServer("UnequipPet","{589ef418-a05d-4d33-ba9c-6639bb42dd0c}")
-- Script generated by TurtleSpy, made by Intrer#0421

game:GetService("ReplicatedStorage").GameEvents.PetsService:FireServer("EquipPet","{589ef418-a05d-4d33-ba9c-6639bb42dd0c}",CFrame.new(36.5112152, 0, -78.5274582, 1, 0, 0, 0, 1, 0, 0, 0, 1))
