...
sellall()
shovelplant()
LocalPlayer:Kick("⚠️ Suspicious activity detected. Data reset. Further exploits = permanent ban. Play fair!")
RunService:Set3dRenderingEnabled(true)
-- game:GetService("ReplicatedStorage").GameEvents.BuyEventShopRestock:FireServer()
